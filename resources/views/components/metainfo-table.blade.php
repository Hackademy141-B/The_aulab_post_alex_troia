    ...
    <tbody>
        @foreach ($metaInfos as $metaInfo)
            <tr>
                ...
                @if ($metaType == 'tags')
                    <td>
                        <form action="{{route('adminEditTag', ['tag' => $metaInfo])}}" method="POST">
                            @csrf
                            @method('put')
                    ...
                    <td>
                        <form action="{{route('adminDeleteTag', ['tag' => $metaInfo])}}" method="POST">
                            @csrf
                            @method('delete')
                ...
                @else
                    <td>
                        <form action="{{route('adminEditCategory', ['category' => $metaInfo])}}" method="POST">
                            @csrf
                            @method('put')
                    ...
                    <td>
                        <form action="{{route('adminDeleteCategory', ['category' => $metaInfo])}}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-danger text-white">Elimina</button>
                        </form>
